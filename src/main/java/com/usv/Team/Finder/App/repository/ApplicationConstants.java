...
public interface ApplicationConstants {
    ...
    String ERROR_ALREADY_DM = "This manager is already assigned to other department!";
    ...
    String ERROR_MESSAGE_PROJECT_TEAM_ROLE = "Project team role does not exist";
    String ERROR_MESSAGE_PROJECT = "Project does not exist";
    String ERROR_CREATE_PROJECT_STATUS = "Invalid project status for creation.";
    ...
    String ERROR_DEPARTMENT_HAS_USERS = "Department has employees, cannot be deleted";
